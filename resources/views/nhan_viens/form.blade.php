...
<!-- <div class="form-group {{ $errors->has('id_chucvu') ? 'has-error' : '' }}">
    <label for="id_chucvu" class="col-md-2 control-label">Chức Vụ</label>
    <div class="col-md-10">
...
<div class="from-group">
    ...
    <div class="col-md-6">
        <select name="id_chucvu" id="id_chucvu" class="form-control">
            @foreach($chucVuList as $id => $tenChucVu)
            <option value="{{ $id }}">{{ $tenChucVu }}</option>
            @endforeach
        </select>
    </div>    
</div>
...
<div class="form-group {{ $errors->has('phone_nv') ? 'has-error' : '' }}">
    <label for="phone_nv" class="col-md-2 control-label">SĐT</label>
    <div class="col-md-10">
...
<div class="form-group {{ $errors->has('email_nv') ? 'has-error' : '' }}">
    <label for="email_nv" class="col-md-2 control-label">Email</label>
    <div class="col-md-10">
...
<div class="form-group {{ $errors->has('address_nv') ? 'has-error' : '' }}">
    <label for="address_nv" class="col-md-2 control-label">Địa Chỉ</label>
    <div class="col-md-10">
...
<div class="form-group {{ $errors->has('username_nv') ? 'has-error' : '' }}">
    <label for="username_nv" class="col-md-2 control-label">Username</label>
    <div class="col-md-10">
...
<div class="form-group {{ $errors->has('password_nv') ? 'has-error' : '' }}">
    <label for="password_nv" class="col-md-2 control-label">Password</label>
    <div class="col-md-10">
