...
<div class="form-group {{ $errors->has('ten_ncc') ? 'has-error' : '' }}">
    <label for="ten_ncc" class="col-md-2 control-label">Tên nhà cung cấp</label>
    <div class="col-md-10">
...
<div class="form-group {{ $errors->has('phone_ncc') ? 'has-error' : '' }}">
    <label for="phone_ncc" class="col-md-2 control-label">SĐT</label>
    <div class="col-md-10">
...
<div class="form-group {{ $errors->has('email_ncc') ? 'has-error' : '' }}">
    <label for="email_ncc" class="col-md-2 control-label">Email</label>
    <div class="col-md-10">
...
<div class="form-group {{ $errors->has('address_ncc') ? 'has-error' : '' }}">
    <label for="address_ncc" class="col-md-2 control-label">Địa chỉ</label>
    <div class="col-md-10">
