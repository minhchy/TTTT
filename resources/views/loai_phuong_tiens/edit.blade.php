...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : 'Cập Nhật Loại Phương Tiện' }}</h4>
            </div>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('loai_phuong_tiens.loai_phuong_tien.update', $loaiPhuongTien->ID_LPT) }}" id="edit_loai_phuong_tien_form" name="edit_loai_phuong_tien_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
